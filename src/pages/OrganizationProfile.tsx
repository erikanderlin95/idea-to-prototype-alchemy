...
const OrganizationProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-3 px-4 space-y-3">
        <div className="max-w-[380px] mx-auto w-full">
          <div className="rounded-2xl border border-[#D0DCE6] bg-white/90 shadow-[0_4px_20px_rgba(13,46,74,0.06)] p-3 overflow-hidden">
            <div className="flex items-center gap-2 mb-2">
              <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-[#E6F7FA] text-[#0E9AAB] text-[11px] font-semibold">
        ...
        <div className="max-w-[380px] mx-auto w-full">
          <div className="rounded-2xl border border-[#D0DCE6] bg-white/90 shadow-[0_4px_20px_rgba(13,46,74,0.06)] p-3 overflow-hidden">
            ...
            <p className="mt-3 text-[11px] text-[#5A7089] leading-snug border-t border-[#E9F0F5] pt-2">
              {t("org.contact3Disclaimer")}
            </p>
          </div>
        </div>
