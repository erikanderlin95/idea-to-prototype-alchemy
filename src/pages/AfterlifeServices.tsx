        ...
        <div className="max-w-[380px] mx-auto w-full">
          <div className="rounded-2xl border border-[#E8DDF0] bg-white/90 shadow-[0_4px_20px_rgba(45,27,78,0.06)] p-4 overflow-hidden">
            ...
            <a
              ...
              className="flex items-center justify-center w-full h-10 rounded-xl bg-[#25D366] hover:bg-[#1DA851] text-white transition-all active:scale-[0.97] shadow-[0_2px_8px_rgba(37,211,102,0.25)]"
            >
              <svg
