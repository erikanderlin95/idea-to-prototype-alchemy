...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "features.queue.description": "Check queue status before heading to the clinic and plan your visit with less uncertainty.",
    "features.book.title": "Book",
    "features.book.subtitle": "",
    "features.book.description": "Book appointments across GP, TCM, and wellness clinics with a simple and consistent flow.",
    "features.connect.title": "Connect",
    "features.connect.subtitle": "",
    "features.connect.description": "Get guided support and follow-ups before and after your visit.",
  ...
  zh: {
    ...
    "features.queue.subtitle": "",
    "features.queue.description": "前往诊所前查看排队状况，减少不确定性，合理规划就诊。",
    "features.book.title": "预约",
    "features.book.subtitle": "",
    "features.book.description": "在全科、中医和健康诊所预约，流程简单一致。",
    "features.connect.title": "连接",
    "features.connect.subtitle": "",
    "features.connect.description": "就诊前后获得引导支持和跟进服务。",
