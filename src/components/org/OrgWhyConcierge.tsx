      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
          <div className="space-y-3">
            ...
            <p className="text-[18px] text-[#12385B] font-medium">This model simplifies it:</p>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-[#DCE8EF] bg-white p-3.5 space-y-2">
                <h3 className="text-[16px] font-bold text-[#5F6F7E]">Unstructured</h3>
              ...
              <div className="rounded-xl border border-[#18B7C9]/20 bg-[#E6F7FA] p-3.5 space-y-2 shadow-[0_2px_12px_rgba(24,183,201,0.1)]">
                <h3 className="text-[16px] font-bold text-[#12385B]">Nanyang Model</h3>
                <ul className="space-y-1">
