        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-[45%_55%] gap-2 items-stretch">
              {/* Stats box - left */}
              <div className="rounded-3xl bg-white border border-[#D0DCE6] shadow-[0_8px_32px_rgba(18,56,91,0.14)] overflow-hidden flex flex-col">
                <div className="px-4 py-3 bg-gradient-to-br from-[#C8D8E8] to-[#DDE8F2] shadow-[0_1px_3px_rgba(18,56,91,0.08)]">
                  <h3 className="text-[1.25rem] md:text-[1.5rem] font-extrabold text-[#0D2E4A] tracking-tight leading-snug text-left">Your Trusted Guide to Private Healthcare in Singapore</h3>
                  <p className="text-[13px] md:text-[14px] text-[#4A5D6E] mt-1 leading-tight text-left">Access trusted clinics, coordinated care, and seamless referrals — all in one place.</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-1.5 rounded-3xl overflow-hidden">
                <div className="relative overflow-hidden rounded-xl">
                  <img src={healthcareConsultation} alt="Doctor consultation" className="w-full h-full object-cover aspect-[4/3] contrast-[1.05] saturate-[1.1]" loading="lazy" width={640} height={640} />
                  <div className="absolute inset-0 bg-[#12385B]/5 mix-blend-multiply" />
                </div>
                <div className="relative overflow-hidden rounded-xl">
                  <img src={healthcareClinic} alt="Modern clinic interior" className="w-full h-full object-cover aspect-[4/3] contrast-[1.05] saturate-[1.1]" loading="lazy" width={640} height={640} />
                  <div className="absolute inset-0 bg-[#12385B]/5 mix-blend-multiply" />
                </div>
                <div className="relative overflow-hidden rounded-xl">
                ...
                <div className="relative overflow-hidden rounded-xl">
                  <img src={healthcarePatient} alt="Patient care" className="w-full h-full object-cover aspect-[4/3] contrast-[1.05] saturate-[1.1]" loading="lazy" width={640} height={640} />
                  <div className="absolute inset-0 bg-[#12385B]/5 mix-blend-multiply" />
                </div>
              </div>
            </div>
...
const TrustStat = ({ value, label }: { value: string; label: string }) => (
  <div className="text-center">
    <p className="text-[24px] font-extrabold text-[#0E9AAB] tracking-tight">{value}</p>
