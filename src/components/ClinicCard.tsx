      ...
      <Card className="group flex flex-col px-3 py-3 sm:px-3.5 sm:py-3 hover:shadow-lg transition-all duration-300 border border-border/40 hover:border-primary/30 cursor-pointer bg-gradient-to-br from-card to-primary/5 onboarding-join-queue w-full max-w-[380px] mx-auto aspect-square" onClick={() => id && navigate(`/clinic/${id}`)}>
        ...
        {myQueueEntry ? (
          ...
          <div className="flex-1 flex flex-col justify-between gap-1.5">
            ...
            <Button 
              variant="outline"
              className="w-full text-xs text-foreground font-semibold h-8 bg-gradient-to-r from-sky-50 to-blue-50 border border-sky-200/60 hover:from-sky-100 hover:to-blue-100 hover:border-sky-300/60"
