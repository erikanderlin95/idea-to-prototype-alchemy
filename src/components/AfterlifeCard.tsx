...
const AfterlifeCard = ({ slug, name, subtitle, description }: AfterlifeCardProps) => {
  ...
  return (
    <Card className="group hover:shadow-[0_14px_40px_rgba(18,56,91,0.18)] hover:-translate-y-1 transition-all duration-300 border-[#C4B5D4] shadow-[0_4px_20px_rgba(18,56,91,0.1)] bg-gradient-to-b from-[#F6F0FA] via-[#F8F4FC] to-[#EDE4F5] overflow-hidden aspect-square max-w-[380px] mx-auto w-full">
      <CardContent className="p-5 flex flex-col items-center justify-center h-full text-center">
        <div className="w-[4.5rem] h-[4.5rem] rounded-xl overflow-hidden mb-3 ring-1 ring-[#D4BFE8] shadow-sm">
