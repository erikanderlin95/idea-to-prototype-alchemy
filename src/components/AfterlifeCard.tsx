...
const AfterlifeCard = ({ slug, name, subtitle, description }: AfterlifeCardProps) => {
  ...
  return (
    <Card className="group hover:shadow-[0_14px_40px_rgba(45,27,78,0.12)] hover:-translate-y-1 transition-all duration-300 border-2 border-gray-200 hover:border-gray-300 shadow-[0_4px_20px_rgba(45,27,78,0.04)] bg-white overflow-hidden aspect-square max-w-[380px] mx-auto w-full">
