        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div className="space-y-3">
            ...
            <p className="text-[17px] text-[#5F6F7E] leading-relaxed max-w-lg">
              Contact us via WhatsApp or hotline to connect with a specialist.
            </p>

            <div className="space-y-2.5">
              <JourneyStep icon={<ClipboardList className="h-4 w-4" />} text="Describe your condition" />
              <JourneyStep icon={<MessageCircle className="h-4 w-4" />} text="Contact via WhatsApp" />
              <JourneyStep icon={<UserCheck className="h-4 w-4" />} text="Receive specialist guidance" />
            </div>
          ...
          <div className="space-y-2">
            <p className="text-[14px] text-[#5F6F7E] leading-relaxed">
              Describe your condition and we will connect you to the appropriate specialist.
            </p>
