...
import { Building2, Stethoscope, Mic, Heart, Menu, ChevronLeft, Mail, ChevronRight, Lock, Info } from "lucide-react";
...
const sections = [
  ...
  { id: "/senior-day-care", key: "sidebar.section.seniorDayCare", icon: null as unknown as typeof Building2, type: "route" as const, emoji: "🧓", iconColor: "text-[#C17A4D] bg-[#FFF3E8]", disabled: false },
