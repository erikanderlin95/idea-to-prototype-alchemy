...
const sections = [
  ...
  { id: "/hovi-care", key: "sidebar.section.seniorDayCare", icon: null as unknown as typeof Building2, type: "route" as const, emoji: "🧓", iconColor: "text-[#C17A4D] bg-[#FFF3E8]", disabled: false },
