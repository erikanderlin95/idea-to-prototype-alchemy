...
import { Building2, Stethoscope, Mic, Heart, Menu, ChevronLeft, Mail, ChevronRight, Lock } from "lucide-react";
...
const sections = [
  ...
  { id: "/senior-day-care", key: "sidebar.section.seniorDayCare", icon: null as unknown as typeof Building2, type: "route" as const, emoji: "🧓", iconColor: "text-amber-600 bg-amber-50", disabled: false },
